...
/* void detectCard() {
  // Reader 1
    //digitalWrite(SS_2, HIGH);   // disable reader 2
    //digitalWrite(SS_1, LOW);    // enable reader 1
    ...
    // Reader 2
    //digitalWrite(SS_1, HIGH);   // disable reader 1
    //digitalWrite(SS_2, LOW);    // enable reader 2
